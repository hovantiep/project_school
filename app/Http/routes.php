...
Route::group(['prefix' => 'quiz'], function () {
    ...
    Route::get('add', ['as' => 'getAddExam', 'uses' => 'ExaminationController@getAdd']);
    Route::post('add', ['as' => 'postAddExam', 'uses' => 'ExaminationController@postAdd']);

    Route::get('mix', ['as' => 'postMixExam', 'uses' => 'ExaminationController@getMix']);
    Route::post('mix', ['as' => 'postMixExam', 'uses' => 'ExaminationController@postMix']);


    Route::get('test', ['uses' => 'ExaminationController@AnswerTable']);
});
