...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="{{ url('backend/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css') }}"
          rel="stylesheet">
...
{{--My script--}}
<script src="{{ url('backend/js/my-script.js') }}"></script>
