            ...
            <div class="col-md-8 banner-bottom-left">
                <div class="banner-bottom-left-grids">
                    <div class="banner-left-grid lifestyle-left-grid">
                        <a href="single.html"><img src="{{ asset('frontend/images/pic1.jpg') }}" alt=""/></a>
                        <h4><a href="single.html">Silicon Valley Shows Signs of Dot-Com Frenzy Quisque eu luctus ex.
                                Pellentesque ullamcorper ac enim vel tincidunt</a></h4>

                        <p class="comments">August 4 2010, <a href="#">8 Comments</a></p>

                        <p class="text">Lorem ipsum ex vix illud nonummy, novum tation et his. At vix scripta patrioque
                            scribentur
                            Maecenas viverra rhoncus sem, nec laoreet sem. Aliquam convallis, nulla ac vehicula
                            efficitur, quam turpis lacinia dolor, iaculis efficitur lacus turpis vitae est. Duis
                            tristique facilisis posuere
                            ...</p>
                    ...
                    <div class="banner-left-grid lifestyle-left-grid">
                        <a href="single.html"><img src="{{ asset('frontend/images/pic5.jpg') }}" alt=""/></a>
                        <h4><a href="single.html">Silicon Valley Shows Signs of Dot-Com Frenzy Quisque eu luctus ex.
                                Pellentesque ullamcorper ac enim vel tincidunt</a></h4>
                    ...
                    <div class="banner-left-grid lifestyle-left-grid">
                        <a href="single.html"><img src="{{ asset('frontend/images/pic6.jpg') }}" alt=""/></a>
                        <h4><a href="single.html">Silicon Valley Shows Signs of Dot-Com Frenzy Quisque eu luctus ex.
                                Pellentesque ullamcorper ac enim vel tincidunt</a></h4>
